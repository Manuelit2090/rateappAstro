...
var _sfc_main = /*@__PURE__*/ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		async function searchRestaurants(category) {
			if (category) activeFilter.value = "All";
		}
		const __returned__ = {
			filters,
			activeFilter,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
	...
	if ($setup.loading) _push(`<div class="text-center py-20"><div class="inline-block"><div class="animate-spin h-12 w-12 border-4 border-primary border-t-transparent rounded-full"></div></div><p class="mt-4 text-neutral">Cargando restaurantes...</p></div>`);
		...
		_push(`<!--]--></div>`);
	} else _push(`<div class="text-center py-20 text-neutral rounded-3xl border border-base-300/60 bg-base-100/40"> No hay restaurantes disponibles. </div>`);
...
var $$Discover = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {
		...
		"client:component-path": "/home/manuel/RateAppProject/rateappAstro/src/components/DiscoverPage.vue",
		"client:component-export": "default"
	})}` })}`;
}, "/home/manuel/RateAppProject/rateappAstro/src/pages/discover.astro", void 0);
var $$file = "/home/manuel/RateAppProject/rateappAstro/src/pages/discover.astro";
var $$url = "/discover";
//#endregion
