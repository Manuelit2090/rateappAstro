...
var $$Search = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result) => renderTemplate`${renderComponent($$result, "RequireAuth", RequireAuth_default, {
		...
		"client:component-path": "/home/manuel/RateAppProject/rateappAstro/src/components/RequireAuth.vue",
		...
		"client:load": true,
		"client:component-hydration": "load",
		"client:component-path": "/home/manuel/RateAppProject/rateappAstro/src/components/UI/RestaurantSearch.vue",
		"client:component-export": "default"
	})}</section></div></main></div>` })}`;
}, "/home/manuel/RateAppProject/rateappAstro/src/pages/search.astro", void 0);
var $$file = "/home/manuel/RateAppProject/rateappAstro/src/pages/search.astro";
var $$url = "/search";
//#endregion
