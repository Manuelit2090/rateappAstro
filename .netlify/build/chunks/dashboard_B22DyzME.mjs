...
import { n as restaurantService, r as RestaurantCard_default } from "./api_CciBLT7p.mjs";
...
var _sfc_main$1 = /*@__PURE__*/ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		const stats = computed(() => [
			...
			{
				icon: Award,
				value: userDisplay.value?.cuponsBuy.length ?? 0,
				label: "Cupones",
				highlight: false
			}
		]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
	...
	if ($setup.locationStatus) _push(`<p class="text-sm text-neutral">${ssrInterpolate($setup.locationStatus)}</p>`);
	else _push(`<!---->`);
	if ($setup.loading) _push(`<div class="text-center py-20"><div class="inline-block"><div class="animate-spin h-12 w-12 border-4 border-primary border-t-transparent rounded-full"></div></div><p class="mt-4 text-neutral">Cargando restaurantes...</p></div>`);
		...
		_push(`<div>`);
		if ($setup.restaurants.length === 0) _push(`<div class="text-center py-20 text-neutral rounded-3xl border border-base-300/60 bg-base-100/40"> No hay restaurantes disponibles entre 4 y 6 km. </div>`);
		else {
...
var $$Dashboard = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<main class="flex-1 min-w-0">${renderComponent($$result, "HeaderPage", HeaderPage_default, {
		...
		"client:component-path": "/home/manuel/RateAppProject/rateappAstro/src/components/ProfileCard.vue",
		...
		"client:load": true,
		"client:component-hydration": "load",
		"client:component-path": "/home/manuel/RateAppProject/rateappAstro/src/components/RestaurantGrid.vue",
		"client:component-export": "default"
	})}</section><footer class="py-10 text-center text-xs text-muted-foreground">© 2026 rateapp</footer></div></main>` })}`;
}, "/home/manuel/RateAppProject/rateappAstro/src/pages/dashboard.astro", void 0);
var $$file = "/home/manuel/RateAppProject/rateappAstro/src/pages/dashboard.astro";
var $$url = "/dashboard";
//#endregion
