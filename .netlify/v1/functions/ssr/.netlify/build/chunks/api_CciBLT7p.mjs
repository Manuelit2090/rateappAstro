...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
	...
	}, _attrs))}><article><div class="relative aspect-[16/10] overflow-hidden"><img${ssrRenderAttr("src", typeof $props.r.image === "object" && $props.r.image !== null ? $props.r.image.src : typeof $props.r.image === "string" ? $props.r.image : "https://pub-d80845b9e313461db9d75fa6897f1bf3.r2.dev/avatar-user.jpg")}${ssrRenderAttr("alt", $props.r.name)} loading="lazy" class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"><div class="absolute inset-0 bg-gradient-to-t from-base-100/90 via-base-100/10 to-transparent"></div>`);
	...
	_push(` ${ssrInterpolate($props.r.distance ? `${Number($props.r.distance).toFixed(2)} km` : "—")}</span><span>${ssrInterpolate($props.r.priceRange)}</span><span>${ssrInterpolate($props.r.reviews.length)} reviews</span></div><div class="flex gap-1.5"><!--[-->`);
...
var restaurantService = {
	getNearby: (lat, lon) => api.get(`/api/restaurants/nearby?lat=${encodeURIComponent(lat)}&lon=${encodeURIComponent(lon)}`),
