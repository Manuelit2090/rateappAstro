...
import { n as showAviso, r as storeUbicacion } from "./alertContainer_C-aVFGS1.mjs";
...
import { n as syncBadgesForUser } from "./badgeVerifier_BYUBfSzH.mjs";
import { computed, defineComponent, mergeProps, onBeforeUnmount, onMounted, ref, useSSRContext } from "vue";
	...
	setup(__props, { expose: __expose }) {
		...
		const loadReviews = async () => {
			...
			try {
				...
				restaurantReviews.value = reviews.map((rev, index) => ({
					...rev,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
	...
	if ($setup.loading) _push(`<p class="text-sm text-secondary text-center py-6"> Cargando reseñas... </p>`);
...
var $$Slug = createComponent(async ($$result, $$props, $$slots) => {
	...
	async function getRestaurantFromDb(slug) {
		...
		return {
			...
			lat: Number(restaurant.latitude ?? restaurant.lat ?? 0),
			lon: Number(restaurant.longitude ?? restaurant.lon ?? 0)
		};
	}
	...
	return renderTemplate`${renderComponent($$result, "LayoutPage", $$BaseLayout, {
		...
		"client:component-path": "/home/manuel/RateAppProject/rateappAstro/src/components/RestaurantDetailClient.vue",
		...
		"resLon": r.lon,
		"client:component-hydration": "load",
		"client:component-path": "/home/manuel/RateAppProject/rateappAstro/src/components/RestaurantDistance.vue",
		"client:component-export": "default"
